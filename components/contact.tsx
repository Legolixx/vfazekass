...
export default function Contact() {
 ...
 return (
  ...
  >
   ...
   <p className='text-gray-700 -mt-6 dark:text-white/80'>Please contact me directly at <a className='underline' href='mailto:victor.fazekas@hotmail.com'>victor.fazekas@hotmail.com</a>
   ...
   <form className='mt-10 flex flex-col dark:text-black'
    ...
    dark:outline-none'
     name='message'
     required maxLength={500} placeholder='Your message' />
    <SubmitBtn />
   </form>
  </motion.section>
 )
